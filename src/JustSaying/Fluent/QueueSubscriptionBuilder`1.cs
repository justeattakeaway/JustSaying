    ...
    where T : Message
{
        ...
        ILoggerFactory loggerFactory)
    {
        ...
        bus.AddQueue(subscriptionConfig.SubscriptionGroupName, new SqsSource { MessageConverter = new MessageConverter(new NewtonsoftMessageBodySerializer<T>(), null), SqsQueue = queue.Queue });
