...
public sealed class InterrogateMiddleware(ILogger<InterrogateMiddleware> logger) : MiddlewareBase<HandleMessageContext, bool>
{
    protected override async Task<bool> RunInnerAsync(HandleMessageContext context, Func<CancellationToken, Task<bool>> func, CancellationToken stoppingToken)
    {
        ...
        {
            logger.LogInformation("[{MiddlewareName}] Hello UnreliableMessage! Hope you work this time....your Name is {Name} and Id is {Id}", nameof(InterrogateMiddleware), unreliableMessage.Name, unreliableMessage.Id);
        }
