...
namespace UnitTests.Serialisation
{
    ...
    public class CustomerOrderNewtonsoftSerialisation
    {
        ...
        {
            // Act
            var result = SerialisationMap.GetSerialiser(typeof(CustomerOrderRejectionSms).ToString()).Deserialise(_serializeObject) as CustomerOrderRejectionSms;
        ...
        {
            // Act
            var result = SerialisationMap.GetSerialiser(typeof (CustomerOrderRejectionSms).ToString()).Serialise(_originalObject);
