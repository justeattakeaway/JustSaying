...
{
    public class WhenPublishingAsyncResponseLoggerAsyncIsCalled : XAsyncBehaviourTest<SnsTopicByName>
    {
        ...
        private readonly IMessageResponseLogger _responseLogger = new DefaultMessageResponseLogger
        {
