...
public class WhenListeningStartsAndStops : BaseSubscriptionGroupTests
{
    ...
    protected override void Given()
    {
        ...
        {
            SqsQueue = sqsQueue,
            MessageConverter = new InboundMessageConverter(new SystemTextJsonMessageBodySerializer<SimpleMessage>(SystemTextJsonMessageBodySerializer.DefaultJsonSerializerOptions).Erase(), new MessageCompressionRegistry(), false)
        };
