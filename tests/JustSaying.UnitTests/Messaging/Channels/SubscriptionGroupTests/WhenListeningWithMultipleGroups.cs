...
public class WhenListeningWithMultipleGroups : BaseSubscriptionGroupTests
{
    ...
    public WhenListeningWithMultipleGroups()
    {
        ...
        var messageConverter = new InboundMessageConverter(new SystemTextJsonMessageBodySerializer<SimpleMessage>(SystemTextJsonMessageBodySerializer.DefaultJsonSerializerOptions).Erase(), new MessageCompressionRegistry(), false);
