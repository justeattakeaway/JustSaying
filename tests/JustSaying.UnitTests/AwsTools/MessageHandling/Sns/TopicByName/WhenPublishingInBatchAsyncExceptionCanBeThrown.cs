...
public class WhenPublishingInBatchAsyncExceptionCanBeThrown : WhenPublishingTestBase
{
    ...
    {
        var topic = new SnsMessagePublisher(TopicArn, Sns, _serializationRegister, NullLoggerFactory.Instance, Substitute.For<IMessageSubjectProvider>(), null, (_, _) => false);
