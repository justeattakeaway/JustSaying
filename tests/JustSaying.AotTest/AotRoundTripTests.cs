...
public sealed class AotRoundTripTests
{
    ...
    public async Task Published_Message_Is_Received_Under_Native_Aot(CancellationToken cancellationToken)
    {
        ...
        // Register an AOT-safe, source-generated System.Text.Json serializer factory before
        // calling AddJustSaying so it wins over the reflection-based Newtonsoft default, which
        // throws under Native AOT.
    ...
    [UnconditionalSuppressMessage("Trimming", "IL2026",
        Justification = "An AOT-safe SystemTextJson source-gen IMessageBodySerializationFactory is registered before AddJustSaying, so the reflection-based default is never used.")]
