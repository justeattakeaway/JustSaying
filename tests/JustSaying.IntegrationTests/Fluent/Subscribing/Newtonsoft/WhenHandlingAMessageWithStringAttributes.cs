    ...
    public async Task Then_The_Attributes_Are_Returned()
    {
        ...
        await WhenAsync(
            ...
            async (publisher, listener, serviceProvider, cancellationToken) =>
            {
                ...
                handler.HandledMessages[0].context.Message.MessageAttributes["content1"].ShouldNotBeNull().StringValue.ShouldBe("somecontent");
                handler.HandledMessages[0].context.Message.MessageAttributes["content2"].ShouldNotBeNull().StringValue.ShouldBe("somemorecontent");
            });
    }
}
