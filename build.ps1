...
$libraryProjects = @(
    ...
    (Join-Path $solutionPath "src" "JustSaying.Extensions.HeaderPropagation" "JustSaying.Extensions.HeaderPropagation.csproj")
)
...
$testProjects = @(
    ...
    (Join-Path $solutionPath "tests" "JustSaying.Extensions.HeaderPropagation.Tests" "JustSaying.Extensions.HeaderPropagation.Tests.csproj")
)
