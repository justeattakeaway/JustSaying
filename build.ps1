...
$libraryProjects = @(
    ...
    (Join-Path $solutionPath "src" "JustSaying.Extensions.Kafka" "JustSaying.Extensions.Kafka.csproj")
)
...
$testProjects = @(
    ...
    (Join-Path $solutionPath "tests" "JustSaying.Extensions.Kafka.Tests" "JustSaying.Extensions.Kafka.Tests.csproj")
)
