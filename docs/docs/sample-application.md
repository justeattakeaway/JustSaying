...
* Alternatively to use your real AWS account
  * Locate the setup code `services.AddJustSaying(...)` in both [`Program.cs`](https://github.com/justeattakeaway/JustSaying/tree/main/samples/src/JustSaying.Sample.Restaurant.KitchenConsole/Program.cs) and [`Startup.cs`](https://github.com/justeattakeaway/JustSaying/tree/main/samples/src/JustSaying.Sample.Restaurant.OrderingApi/Startup.cs)
